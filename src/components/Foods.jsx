...
import {foodList} from '../data/data.js';
      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        ...
        <div>
          ...
          <div className='flex justfiy-between flex-wrap'>
            <button
              ...
              className='m-1 border-orange-600 text-green-500 hover:bg-orange-600 hover:text-white'
            >
              All
            </button>
            <button
        ...
        <div>
          ...
          <div className='flex justify-between max-w-[390px] w-full'>
            <button
              onClick={() => filterPrice('$')}
              className='m-1 border-orange-600  text-green-700 hover:bg-orange-600 hover:text-white'
            >
                $
            </button>
            <button
